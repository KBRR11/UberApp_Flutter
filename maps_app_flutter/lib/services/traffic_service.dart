...
class TrafficService {
  ...
  final _baseUrlManual = 'https://api.mapbox.com/directions/v5';

  /// se usa manualmente con un punto LatLng de destino
  final _baseUrlRequest =
      'https://api.mapbox.com/geocoding/v5'; // se envía el nombre de un lugar como destino, tambien sirve para obterner informacion de un punto específico
  ...
  Future<SearchResponse> getResultadosRequest(
      String busqueda, LatLng miUbicacion) async {
  ...
  Future<ReverseQueryResponse> getCoordenadasInfo(LatLng destino) async {
    ...
    final url =
        '${this._baseUrlRequest}/mapbox.places/${destino.longitude},${destino.latitude}.json';
